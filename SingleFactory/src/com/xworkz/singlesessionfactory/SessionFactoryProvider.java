...
public class SessionFactoryProvider {
	...
	static {
		sessionFactory = new Configuration().configure("Hybernate.cfg.xml").buildSessionFactory();
	 ...
	 * getSessionFactory(); System.out.println(sessionFactory.hashCode());
	 * SessionFactory sessionFactory1 = getSessionFactory();
	 * System.out.println(sessionFactory1.hashCode()); SessionFactory
